    ...
    fluidRow(
      column(3, 
             wellPanel(
               ...
               radioButtons(inputId = "continuous_variable", label = "Continuous:",
                            choices = c("age", "hours_per_week")),   # add radio buttons for continuous variables
               radioButtons(inputId = "graph_type", label = "Graph:",
    ...
    fluidRow(
      column(3, 
             wellPanel(
               ...
               radioButtons(inputId = "categorical_variable", label = "Categorical:",
